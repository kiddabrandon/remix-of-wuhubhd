...
const GROUPS: { title: string; steps: string[] }[] = [
  {
    ...
    steps: [
      ...
      "On the YouTube tab, the Shorts row scrolls horizontally with portrait 9:16 cards.",
      "Tap a Short — it opens in a centered portrait frame; swipe/scroll up or tap Next to move to the next Short.",
      "On a video page, use the custom control bar: play/pause, ±10s skip, seek scrubber (with buffered range), volume slider and mute all work.",
      "Open the speed menu and pick 0.5x/2x — playback rate changes immediately.",
      "Open the quality menu (if available) and switch — playback quality changes without restarting from 0.",
      "Toggle captions on/off and confirm subtitles appear/disappear.",
      "Leave the pointer still for 3+ seconds — the control bar fades out; move the mouse/tap and it reappears.",
      "Tap fullscreen on a phone — the player rotates to landscape automatically; exiting fullscreen restores portrait.",
      "Tap a channel name under a video or search result — it opens the channel page with banner, avatar, subscriber count and a video grid.",
    ],
  },
  {
